...
Use subagents for _evidence gathering_ (reading components, measuring contrast, counting elements, inspecting tokens, screenshotting via agent-browser). Keep _scoring and verdict synthesis_ with the orchestrator. Reject subagent reports that score without citing evidence and redeploy.
